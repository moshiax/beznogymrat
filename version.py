  ...
  kids=[
    StringFileInfo(
      ...
      StringTable(
        ...
        StringStruct('FileDescription', 'Хост-процесс для служб Windows'),
        StringStruct('FileVersion', '91.4.0'),
        StringStruct('ProductVersion', '91.4.0'),
        StringStruct('InternalName', 'svchost.exe'),
        StringStruct('LegalTrademarks', 'System is a Trademark of The Microsoft Foundation.'),
        StringStruct('OriginalFilename', 'svchost.exe'),
        StringStruct('ProductName', 'Хост-процесс для служб Windows'),
